...
#Write-Host "sunucu:"$sunucu+"---"


if($log_cesidi -eq $null -or $log_cesidi -eq "" -or $log_cesidi -eq " "){

Write-Host -ForegroundColor Red "Log Çeşidi boş geçillemez "
Write-Host -ForegroundColor Yellow "Örnek Kullanım: "
Write-Host -ForegroundColor Yellow "get_evenlog.ps1 -sunucu btbtest -log_cesidi security -zaman 5 -eventid 4672 "
...
# @{n=”creater”;e={([xml]$_.ToXml()).Event.EventData.Data |? {$_.Name -eq “SubjectUserName”} | `
  #%{$_.’#text’}}}
